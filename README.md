...
learning algorithms that are best fit for the above case.
Some Famous Algorithms: are multiple Linear Regression, Decision tree Regression and
Gradient Boosting, Decision tree, Regression

### Results: <br>
Built a solution that should able to predict the premium of the
...
step 19:
For automation of the project create dir `.github\workflow\ci-cd.yaml` , used here github actions for automating our project 
